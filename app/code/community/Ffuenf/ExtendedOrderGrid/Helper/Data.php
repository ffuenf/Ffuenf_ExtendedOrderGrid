...
class Ffuenf_ExtendedOrderGrid_Helper_Data extends Ffuenf_Common_Helper_Core
{
    /**
     * Path for the config for extension active status.
     */
    const CONFIG_EXTENSION_ACTIVE = 'ffuenf_extendedordergrid/general/enable';

    /**
     * Path for the config for extension system log status.
     */
    const CONFIG_EXTENSION_LOG_SYSTEM_ACTIVE = 'ffuenf_extendedordergrid/log/enable';

    /**
     * Path for the config for extension profile log status.
     */
    const CONFIG_EXTENSION_LOG_PROFILE_ACTIVE = 'ffuenf_extendedordergrid/log/profile_enable';

    /**
     * Path for the config for extension exception log status.
     */
    const CONFIG_EXTENSION_LOG_EXCEPTION_ACTIVE = 'ffuenf_extendedordergrid/log/exception_enable';
